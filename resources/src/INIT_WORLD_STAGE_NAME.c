...
void INIT_WORLD_STAGE_NAME(void)
{
    ...
    switch(t_world_info[num_world_choice].world) 
    {
        // Jungle
        case 1:
            strcpy(text_to_display[2].text, (char *)0x8012ba28);
            color = 7;
            break;

        // Music
        case 2:
            strcpy(text_to_display[2].text, (char *)0x8012ba3c);
            color = 4;
            break;

        // Mountain
        case 3:
            strcpy(text_to_display[2].text, (char *)0x8012ba48);
            color = 0xd;
            break;

        // Image
        case 4:
            strcpy(text_to_display[2].text, (char *)0x8012ba5c);
            color = 0;
            break;

        // Cave
        case 5:
            strcpy(text_to_display[2].text, (char *)0x8012ba6c);
            color = 2;
            break;

        // Cake
        case 6:
            strcpy(text_to_display[2].text, (char *)0x8012ba80);
            color = 1;
            break;
